...
function HighlightQuery({ text, query }) {
  return (
    <Highlighter
      highlightClassName="underline bg-transparent text-synergie"
      searchWords={[query]}
      autoEscape={true}
  ...
  return (
    ...
    >
      <div
        id={`${id}-title`}
        aria-hidden="true"
        className="group-aria-selected:text-synergie text-sm font-medium text-zinc-900 dark:text-white"
      >
